...
namespace game
{
    ...
    {
        public:
            static std::shared_ptr<spic::GameObject> CreateBullet(BulletType bulletType, const spic::Point& position, const std::string& targetTag, const spic::Point& direction, int range, int damage);
