...
const int ShotgunTowerCost = 350; // The amount of money it takes or the player to buy one
...
const int FlamethrowerTowerCost = 450; // The amount of money it takes or the player to buy one
const double FlamethrowerTowerFireRate = 0.1; // The shooting interval of the flamethrower tower
const int FlamethrowerTowerRange = 50; // The detection range of the hero for the flamethrower tower
...
const int BomberTowerCost = 650; // The amount of money it takes or the player to buy one
...
const int SniperTowerCost = 600; // The amount of money it takes or the player to buy one
